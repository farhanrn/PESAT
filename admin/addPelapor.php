...
if ($_SESSION['role'] === 'koordinator') {
    ...
    ?>
            ...
            <head>
                ...
                <title>Tambah User Pelapor</title>
            ...
            <body>
                <div class="formbold-main-wrapper">
                    ...
                    <div class="formbold-form-wrapper">
                        <img src="../assets/img/addPelaporImage.png" alt="Image">

                        <form action="addPelaporAction.php" method="POST">
                            <div class="formbold-form-title">
                                <h2>Tambah Data Pelapor</h2>
                                <p>
                                    Tambahkan Data Pelapor Dari Departemen Tertentu
                                </p>
                            </div>

                            <div class="formbold-mb-3">
                                <label for="nama" class="formbold-form-label">Nama Departmen</label>
                                <input type="text" name="nama" class="formbold-form-input">
                            </div>
                            <div class="formbold-mb-3">
                            ...
                            <div class="formbold-input-flex">
                                ...
                                <div>
                                    <label for="text" class="formbold-form-label">Password</label>
                            ...
                            <button class="formbold-btn" input type="Submit">Buatkan Akun pelapor baru</button>
                        </form>
                    </div>
                </div>

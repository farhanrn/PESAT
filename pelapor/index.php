    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Laporkan setiap alat yang rusak</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Aplikasi terintegrasi bersama pelapor, teknisi, admin dan
            koordinator
            yang berada dalam Stasiun Meteorologi Kelas I Sultan Hasanuddin
          </h2>
        ...
        <div class="col-lg-6 hero-img aos-init aos-animate" data-aos="zoom-out" data-aos-delay="200"><img
            src="assets/img/features.png" class="img-fluid" alt=""></div>
      </div>
    </div>
